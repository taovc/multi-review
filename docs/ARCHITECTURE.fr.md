...
app/       UI : navigation projets ; page projet (Toutes les PR / Configuration + tiroir de l'assistant : sessions dossier / nouvelle branche) ; drawer PR (Revue IA / Correction / Timeline / Modifs)
